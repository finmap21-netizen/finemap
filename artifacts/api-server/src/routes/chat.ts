...
معلومات قانونية وضريبية هامة يجب أخذها بعين الاعتبار للإجابة على المستخدم:
- كشف الرواتب والأجور (سلسلة ج رقم 29) : تصريح شهري مع ذكر رقم التعريف الوطني (NIN) لكل أجير. عدم التصريح: غرامة 5% على الكتلة السنوية للأجور. (المادة 13 ق.م 2024)
- التصريح السنوي (في أجل أقصاه 30 أفريل) : IBS عبر G رقم 4، الحزمة الجبائية، الجدول 104 (تفاصيل الزبائن)، الدفع الجزافي لـ IRG الأجور (G رقم 29).
- متبقى التصفية (في أجل أقصاه 20 ماي) : عبر G رقم 50، وإرسال جدول ملخص سنوي على دعامة معلوماتية أو عبر التصريح عن بعد "جبايتيك".
- بالنسبة للشركات التي ليس لها منشأة مهنية دائمة في الجزائر : إلزامية الاكتتاب الإلكتروني لتصريح التنازل « G 17 مكرر » في أجل 30 يوما من تاريخ التنازل، حتى في حالة عدم تحقيق فائض قيمة. (المادة 12 ق.م 2025)` }
      },
      generationConfig: {
        temperature: 0.3,
      }
